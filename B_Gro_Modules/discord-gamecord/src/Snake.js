...
module.exports = class SnakeGame extends events {
  ...
  async startGame(){
    ...
    const up = new ButtonBuilder().setEmoji(`1108935528084160542`).setStyle(buttonStyle('PRIMARY')).setCustomId('snake_up');
    const down = new ButtonBuilder().setEmoji(`1108935533528354876`).setStyle(buttonStyle('PRIMARY')).setCustomId('snake_down');
    const left = new ButtonBuilder().setEmoji(`1108935538922242138`).setStyle(buttonStyle('PRIMARY')).setCustomId('snake_left');
    const right = new ButtonBuilder().setEmoji(`1108935544039297127`).setStyle(buttonStyle('PRIMARY')).setCustomId('snake_right');
