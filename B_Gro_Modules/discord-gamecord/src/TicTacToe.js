...
module.exports = class TicTacToe extends approve {
  constructor(options = {}){
    ...
    if(!options.timeoutMessage) options.timeoutMessage = 'The Game Was Unfinished!';
    if(!options.requestMessage) options.requestMessage = '{player} Has Invited You For Game(TicTacToe).';
