...
module.exports = class Flood extends events {
  constructor(options = {}) {
    ...
    if (!options.winMessage) options.winMessage = 'You Won The Game In **{turns}** Turns.';
    if (!options.loseMessage) options.loseMessage = 'You Have Lost Game, BTW You Took **{turns}** Turns.';
