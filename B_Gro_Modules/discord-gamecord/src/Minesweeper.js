...
module.exports = class Minesweeper extends events {
  constructor(options = {}) {
    ...
    if (!options.embed.description) options.embed.description = 'Click On The Buttons To Reveal The Block. BTW There Are Some Mines🫣 In Some Blocks Be Safe.';
    ...
    if (!options.winMessage) options.winMessage = 'You Won Game Without Touching Any Mines.';
    if (!options.loseMessage) options.loseMessage = 'You Have Touched Mine. Better Luck Next Time';
