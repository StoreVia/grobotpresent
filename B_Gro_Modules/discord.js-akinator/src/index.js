...
module.exports = async function (input, options = {}) {
    ...
    try {
        ...
        const startingEmbed = new Discord.EmbedBuilder()
        .setAuthor({name: usertag, iconURL: avatar})
        .setThumbnail(`https://i.imgur.com/SCjjjEa.png`)
        .setTitle(`${translations.startingGame}`)
        .setDescription(`**${translations.startingGameDesc}**`)
      ...
      iconURL: process.env.iconurl
        ...
        const noResEmbed = new Discord.EmbedBuilder()
        .setAuthor({name: usertag, iconURL: avatar})
        .setThumbnail(`https://i.imgur.com/SCjjjEa.png`)
      ...
      iconURL: process.env.iconurl
        ...
        const akiEmbed = new Discord.EmbedBuilder()
        .setAuthor({name: usertag, iconURL: avatar})
        .setThumbnail(`https://i.imgur.com/SCjjjEa.png`)
        ...
        while (notFinished) {
            ...
            if (((aki.progress >= 95 && (stepsSinceLastGuess >= 10 || hasGuessed == false)) || aki.currentStep >= 78) && (!attemptingGuess.has(inputData.guild.id))) {
                ...
                let guessEmbed = {
                    ...
                    footer: { text: `${cu} - ${process.env.year} ©`, iconURL: process.env.iconurl },
