	...
	async run(client, message, args) {
        ...
        if(!string){
            ...
            if(langCodes.includes(`${string}`)){
                ...
                let msg = await message.reply({ content: `> Language Code Doesn't Exist. Once User "${process.env.prefix}akilangcodes" Command To Check Language Code.`, components: [buttonRow] })
                collector(msg);
            }
        }
