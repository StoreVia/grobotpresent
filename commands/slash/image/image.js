	...
	async run(client, interaction) {
        ...
        if(subcommand === "filter"){
            ...
            if(StringOption == "img_gay"){
                ...
                return await interaction.followUp({ files : [{ attachment: `${process.env.srapi}/canvas/Gay?avatar=${gay_user}`, name: 'image.png' }]});
            }
        ...
        if(subcommand === "youtube"){
            ...
            return await interaction.followUp({ files : [{ attachment: `${process.env.srapi}/canvas/youtube-comment?avatar=${youtubeuseravatar}&username=${youtubeusername}&comment=${comment}`, name: 'image.png' }]});
        }
	}
};