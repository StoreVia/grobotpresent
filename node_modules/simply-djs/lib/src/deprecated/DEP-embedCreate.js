"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.embedCreate=void 0;const error_1=require("../error"),embedCreator_1=require("../embedCreator");
/**
 * ## _~embedCreate~_
 ...
 *
 */
async function embedCreate(msgOrint,options={}){return(0,error_1.Deprecated)({desc:"embedCreate() is now embedCreator()"}),(0,embedCreator_1.embedCreator)(msgOrint,options)}exports.embedCreate=embedCreate;