"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.emitError=void 0;const SimplyError_1=require("../error/SimplyError");
/**
 * ## emitError
 ...
 */async function emitError(options={tip:"Get ya help here -> [https://discord.gg/3JzDV9T5Fn]"}){
// Just throws the SimplyError
throw new SimplyError_1.SimplyError(options)}exports.emitError=emitError;